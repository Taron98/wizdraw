...
//        return ((sizeof($clientLastTransfersBetweenDates)) < 5 && ($client->defaultCountryId === 90)) ? true : false;
    ...
    public function isNotBlackListed(Client $sender, $receiver)
    {
        ...
        $response = $client->request("POST", config('app.WIC_INTERNAL_API_URI'), $params);
        ...
        $receiverResponse = $client->request("POST", config('app.WIC_INTERNAL_API_URI'), $receiverParams);
