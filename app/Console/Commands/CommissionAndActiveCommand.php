...
class CommissionAndActiveCommand extends Command
{
    ...
    {
        $json[] = ['119' => ['PHILIPPINES'], '90' => ['NEPAL', 'THAILAND', 'PHILIPPINES', 'INDIA', 'SRI LANKA'], '91' => ['PHILIPPINES'], '13' => ['THAILAND', 'PHILIPPINES', 'INDIA', 'SRI LANKA', 'NEPAL',  'GEORGIA', 'MOLDOVA', 'UKRAINE', 'RUSSIAN FEDERATION', 'VIETNAM', 'CHINA', 'ARMENIA']];
